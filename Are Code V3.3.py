...
def inter_veget(veg,alimentation,capadap,vegre):
   ...
   while vegr>0 and trouve==True:
       ...
       if rand * (capadap)+0.06 >=p_vg:
           alimentation = alimentation + 0.11*(capadap+0.21)
           vegr = vegr - 1
           p_vg = p_vg+0.08
       else:
           trouve=False
...
secouru(0.00043185564,0,0.00666666,0)
...
simulation_survie("moyen","Alaska","grizzly",15)
...
while a !=0 :
    a=a-1
    print(simulation_survie("moyen","Alaska","grizzly",15))
